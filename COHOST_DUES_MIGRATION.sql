/*
  # Add Co-Host Dues Calculation - RUN THIS IN SUPABASE SQL EDITOR
  ...
  3. Example:
    - JUNAID (sub-client) adds meeting with 100 members
    - Admin marks as attended
    - Vinod (co-host) gets Rs 100 added to his daily_dues (100 members * 1 INR)
    - JUNAID also gets his dues calculated separately at his rate
*/

                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      className="px-3 py-2.5 rounded-xl border border-gray-300 focus:border-slate-500 focus:ring-2 focus:ring-slate-200 outline-none transition-all bg-white"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 rounded-xl border border-gray-300 focus:border-slate-500 focus:ring-2 focus:ring-slate-200 outline-none transition-all"

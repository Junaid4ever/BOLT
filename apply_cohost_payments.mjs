...
const sql = readFileSync('/tmp/cc-agent/58752285/project/add_cohost_payment_methods.sql', 'utf-8');

console.log('Adding cohost support to payment_methods...');
...
if (error) {
  ...
  console.log('✅ Cohost payment methods support added successfully!');
}
